...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg fixed-top nav-menu">
            <a href="#" class="navbar-brand text-light text-uppercase"><span
                    class="h2 font-weight-bold">Foto</span><span class="h1">X</span> </a>
            ...
            <div class="collapse navbar-collapse justify-content-end text-uppercase font-weight-bold" id="myNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item>">
                        <a href="phpreview/index.html" class="nav-link m-2 menu-item">Reviews</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="text-light text-md-right text-center banner">
            <h1 class="display-4 banner-heading">Welcome to <span class="text-uppercase">Foto<span
                        class="display-3">X</span></h1>
            <P class="lead banner-par">In the world of photography, you get to share a captured 
                moment with other people!</P>
        </div>
    ...
    <section class="p-5 mission">
            ...
            <div class="row text-white text-center">
                <div class="col md-4">
                    ...
                    <p class="lead">Lorem ipsum, dolor sit amet consectetur adipisicing elit
                        andae natus facere facilis eligendi, blanditiis modi enim sequi animi saepe rem
                        nisi voluptates inventore nulla.</p>
                </div>
            </div>
            <!--end of title-->
            <div class="row my-5">
                <div class="col-md-4 text-center">
                    ...
                    <p class="text-muted">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nihil aliquid dicta
                        nobis id enim?enetur esse aut vero doloribus! Labore!
                    </p>
                </div>
                <div class="col-md-4 text-center">
                    <i class="far fa-thumbs-up fa-5x text-danger mb-4"></i>
                    <h1 class="text-white mb-3">Quality</h1>
                    <p class="text-muted">Lorem ipsum dolor s it, amet consectetur adipisicing elit. Nihil aliquid dicta
                        nobis id enim?enetur esse aut vero doloribus! Labore!
                    </p>
                </div>
            </div>
        ...
        <div class="conatainer">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 text-white text-lg-right text-center
                mission-text">
                    <h1>We know what we do</h1>
                    <p lead>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia ducimus, beatae animi cum
                        molestiae qui, nemo repellat esse debitis et unde ipsa labore maiores at itaque, tempore veniam
                        tempora eaque?</p>
                </div>
            </div>
        </div>
    ...
    <section class="bg-secondary py-4">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4  col-sm-6 my-5">
                    <div class="card border-0 card-shadow">
                        <img src="images/mirabel2.jpg" class="card-img">
                        <div class="card-img-overlay">
                ...
                <div class="col-lg-4  col-sm-6 my-5">
                    <div class="card border-0 card-shadow">
                        <img src="images/fashion3.jpg" class="card-img">
                        <div class="card-img-overlay">
    ...
    <section class="py-5">
        <div class="container-fluid">
            ...
            <ul class="list-inline text-center text-uppercase font-weight-bold my-4">
                <li class="list-inline-item gallery-list-item active-item" data-filter="all">All<span
                        class="mx-md-5 mx-3 text-muted">/</span></li>
                <li class="list-inline-item gallery-list-item" data-filter="new">New<span
                        class="mx-md-5 mx-3 text-muted">/</span></li>
                <li class="list-inline-item gallery-list-item" data-filter="free">Free<span
                        class="mx-md-5 mx-3 text-muted">/</span></li>
 ...
 <div class="row">
  <div class="col-md-6 mx-auto">
     ...
     <ol class="carousel-indicators">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active text-center">
            <img src="images/customer1.jpeg" class="img-fluid rounded-circle a-5" width="150">
              <blockquote class="blockquote text-white">
                <p class="mb-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi
                 molestiae, eius doloralias est nihil earum cum esse accusantium eligendi ev</p>
            </blockquote>
    <h5 class="text-light text-uppercase 
        font-weight-bold mb-3">Oluomachi</h5>
    <ul class="list-inline mb-5">
        <li class="list-inline-item">
          ...
          <div class="carousel-item  text-center">
            <img src="images/customer2.jpeg" class="img-fluid rounded-circle a-5" width="150">
              <blockquote class="blockquote text-white">
                <p class="mb-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi
                 molestiae, eius doloralias est nihil earum cum esse accusantium eligendi ev</p>
            </blockquote>
    <h5 class="text-light text-uppercase 
        font-weight-bold mb-3">Menorah</h5>
    <ul class="list-inline mb-5">
        <li class="list-inline-item">
          <li class="fas fa-star text-warning"></li>
         </li>
          ...
          <div class="carousel-item  text-center">
            <img src="images/customer3.jpeg" class="img-fluid rounded-circle a-5" width="150">
              <blockquote class="blockquote text-white">
                <p class="mb-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi
                 molestiae, eius doloralias est nihil earum cum esse accusantium eligendi ev</p>
            </blockquote>
    <h5 class="text-light text-uppercase 
        font-weight-bold mb-3">Olise</h5>
    <ul class="list-inline mb-5">
        <li class="list-inline-item">
          <li class="fas fa-star text-warning"></li>
         </li>
    ...
    <div class="row align-items-center">
     <div class="col-lg-4">
         <div class="card card-1 py-4 my-4 mx-auto">
          <div class="card-body">
                <h5 class="text-uppercase font-weight-bold
                mb-5">Monthly Membership</h5>
                <h1 class="display-4"><i class="fas 
                 fa-dollar-sign"></i> 19</h1>
                <ul class="list-unstyled">
                <li class="font-weight-bold py-3
                 card-list-item">Photshop</li>
                <li class="font-weight-bold py-3
                 card-list-item">After Effects</li>
                <li class="font-weight-bold py-3
                 card-list-item">Graphic Design</li>
                <li class="font-weight-bold py-3
                 card-list-item border-0">Video Montage</li>
                 </ul>
                <a href="#" class="btn p-2
                text-uppercase font-weight-bold price-card-button">Sign-up</a>
            </div>
         </div>
       </div>
     <div class="col-lg-4">
         <div class="card card-2 py-4 my-4 mx-auto">
          <div class="card-body">
                <h5 class="text-uppercase font-weight-bold
                mb-5">Unlimted Access </h5>
                <h1 class="display-4"><i class="fas 
                 fa-dollar-sign"></i> 499</h1>
                <ul class="list-unstyled">
                <li class="font-weight-bold py-3
                 card-list-item">Photshop</li>
                <li class="font-weight-bold py-3
                ...
                <li class="font-weight-bold py-3
                 card-list-item">Graphic Design</li>
                <li class="font-weight-bold py-3
                 card-list-item">Video Montage</li>
                <li class="font-weight-bold py-3
                 card-list-item border-0">Clip Making</li>
                 </ul>
                <a href="#" class="btn p-2
                text-uppercase font-weight-bold price-card-button">Sign-up</a>
            </div>
     ...
     <div class="col-lg-4">
         <div class="card card-3 py-4 my-4 mx-auto">
          <div class="card-body">
                <h5 class="text-uppercase font-weight-bold
                mb-5">Annual Membership </h5>
                <h1 class="display-4"><i class="fas 
                 fa-dollar-sign"></i> 199</h1>
                <ul class="list-unstyled">
                <li class="font-weight-bold py-3
                 card-list-item">Photshop</li>
                <li class="font-weight-bold py-3
         ...
         <form class="contact-form">
           ...
           <div class="form group py-4">
            ...
            <div class="form-group py-4 my-4">
                ...
                <label for="check" class="text-white">Send Notification</label>
            </div>
            <button type="submit" class="btn btn-block 
            p-2 font-weight-bold
            text-uppercase submit-button">Subcribe</button>
         </form>
      </div>
    </div> 
  </div>
        ...
        <div class="row text-light py-4">
            <div class="col-lg-4 col-sm-6">
                ...
                <p class="small">Lorem, ipsum dolor sit amet consectetur adipisicing
                     elit. Ipsam ipsa fugit earum quis quos placeat
                      repellendus exercitationem, dicta porro numquam
                       dolores doloribus, perferendis dolore 
                    laudantium ad consequatur debitis molestiae sed.</p>
            </div>
            ...
            <div class="col-lg-2 col-sm-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                    <a href="#" class="text-info">iwuoriehc@gmail.com</a>
                </li>
                </ul>
            </div>
            <div class="col-lg-4 col-sm- 6">
                ...
                <p class="small">
                    Lorem ipsum dolor sit amet consectetur
                     adipisicing elit. Iusto minima impedit quo eaque 
                     quibusdam, iste architecto aliquam fugiat eligendi
                     ccusantium quos assumenda a
                    consequatur magni cupiditate laboriosam eum sapiente.
                </p>
                <form class="mb-3">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            ...
                            text-white text-uppercase font-weight-bold">Sign Up </button>
                        </div>
                    </div>
                </form>
                <ul class="list-inline">
                    ...
                    <i class="fab fa-facebook
                     fa-2x text-primary"></i></li>
                    <li class="list-inline-item">
                    <i class="fab fa-google-plus
                     fa-2x text-danger"></i></li>
                    <li class="list-inline-item">
                    <i class="fab fa-instagram
                     fa-2x text-danger"></i></li>
                    <li class="list-inline-item">
                    <i class="fab fa-twitter
                     fa-2x text-info"></i></li>
                    <li class="list-inline-item">
